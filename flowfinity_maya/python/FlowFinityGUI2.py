...
class FlowFinityGUI(QtWidgets.QDialog):
    ...
    def create_widgets(self):
        ...
        self.agent_acceleration.setRange(0.1, 40.0)
        self.agent_acceleration.setValue(15.0)
        ...
        self.agent_drag.setRange(0.1, 20.0)
        self.agent_drag.setValue(5)
        ...
        self.agent_radius.setValue(0.25)
